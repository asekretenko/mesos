...
// Tests a single NonStringOrEqualsString constraint on a named attribute.
TEST(OfferConstraintsFilter, NamedAttributeNonStringOrEqualsString)
{
  Try<OfferConstraints> constraints = OfferConstraintsFromJSON(R"~(
    {
      "role_constraints": {
        "roleA": {
          "groups": [{
            "attribute_constraints": [{
              "selector": {"attribute_name": "bar"},
              "predicate": {"non_string_or_equals_string": {"value": "baz"}}
            }]
          }]
        }
      }
...
// Tests a single NotEqualsString constraint on a named attribute.
TEST(OfferConstraintsFilter, NamedAttributeNotEqualsString)
{
  Try<OfferConstraints> constraints = OfferConstraintsFromJSON(R"~(
    {
      "role_constraints": {
        "roleA": {
          "groups": [{
            "attribute_constraints": [{
              "selector": {"attribute_name": "bar"},
              "predicate": {"not_equals_string": {"value": "baz"}}
            }]
          }]
        }
      }
